...
class WeatherCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.shader = ui.Gradient.linear(Offset(0,size.height*0.7314286), Offset(size.width*1.035503,size.height*0.7314286), [const Color(0xff5835B2).withOpacity(1),const Color(0xff392C88).withOpacity(1)], [0,1]);
